...
static const char *fonts[]          = { "monospace:size=10", "Inconsolata:pixelsize=10:antialias=true:autohint=true"  };
...
static Key keys[] = {
	...
	{ MODKEY|ShiftMask,		XK_minus,	spawn,		SHCMD("amixer set 'Master' 15%-; kill -44 $(pidof dwmblocks)") },
	{ MODKEY,			XK_equal,	spawn,		SHCMD("amixer set 'Master' 5%+; kill -44 $(pidof dwmblocks)") },
	{ MODKEY|ShiftMask,		XK_equal,	spawn,		SHCMD("amixer set 'Master' 15%+; kill -44 $(pidof dwmblocks)") },
	...
	{ MODKEY,			XK_m,		spawn,		SHCMD("st -e lf") },
	...
	{ MODKEY|ShiftMask,		XK_m,		spawn,		SHCMD("amixer set 'Master' toggle; kill -44 $(pidof dwmblocks)") },
	...
	{ MODKEY,			XK_F6,		spawn,		SHCMD("setxkbmap us") },
	{ MODKEY,			XK_F7,		spawn,		SHCMD("setxkbmap 'bd(probhat)'") },
